...
public final class EditorKeywordHelperImplCSharp extends EditorKeywordHelperImplJava{
    private final String[] keywords = new String[] {
            ...
            "else", "enum", "event", "explicit", "extern", "false", "file", "finally", "fixed", "float", "for", "foreach",
            ...
            "managed", "remove", "required", "scoped", "select", "set", "unmanaged", "value", "var", "when",
            "where", "with", "yield", "Cdecl", "Fastcall", "Stdcall", "Thiscall",
    };
    @Override
